...
proc create_root_design { parentCell } {
  ...
  # Create instance: aadder_AXIS_wrapper_0, and set properties
  set block_name aadder_AXIS_wrapper
  set block_cell_name aadder_AXIS_wrapper_0
  if { [catch {set aadder_AXIS_wrapper_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $aadder_AXIS_wrapper_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net aadder_AXIS_wrapper_0_m_axis [get_bd_intf_pins aadder_AXIS_wrapper_0/m_axis] [get_bd_intf_pins axis_data_fifo_0/S_AXIS]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins aadder_AXIS_wrapper_0/s_axis] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
